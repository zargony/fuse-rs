...
use time::Timespec;
use kernel::{fuse_attr, fuse_attr_out, fuse_entry_out, fuse_file_lock, fuse_kstatfs};
use kernel::{fuse_bmap_out, fuse_lk_out, fuse_open_out, fuse_statfs_out, fuse_write_out};
use kernel::fuse_getxattr_out;
#[cfg(target_os = "macos")]
use kernel::fuse_getxtimes_out;
use kernel::{fuse_dirent, fuse_out_header};
use {FileAttr, FileType};
            ...
            expected: if cfg!(target_os = "macos") {
                vec![
                    ...
                    vec![
                        ...
                        0x34, 0x12, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x78, 0x56, 0x00, 0x00,
                        0x78, 0x56, 0x00, 0x00, 0x11, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
